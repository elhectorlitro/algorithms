...
if (number_of_tries==0) : print("Number "+ str(to_guess)+" could no be found")
else : print("Number "+ str(to_guess)+" located at position "+str(number_guessed)+" after "+str(number_of_tries)+" tries")
